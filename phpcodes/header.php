...
<div class="header">
	<div class="logo">
		<a href="index.php"> Binangonan BOAT Station</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
...
<div class="topnav" id="myTopnav">
	...
	<a href="index.php">Users List</a>
       ...
       <a href="addresetcard.php">Add New Reset Card</a>
       <a href="reset_card_list.php">Reset Card List</a>
       <a href="updatelimit.php">Update Log(Capacity) Count</a>
        <a href="UsersLog.php">Passengers Log</a>
	<a href="testingLog.php">Departure Records</a>
	<a href="display_users.php">Incoming Registration</a>
        <a href="devices.php">Devices</a>
	<a href="LoaderWeb.php"> Load Card</a>
    <?php  
